    ...
    <div class="section center" style="padding: 40px;">
        ...
        <form action="../backends/admin/food-add.php" method="post">
            ...
            <div class="rowF">
                ...
                <input id="p" name="prix" type="float" class="validate" style="color: black; ">
            ...
            <div class="rowF">
                ...
                <input id="desc" name="desc" type="text" class="validate" style="color: black; ">
            ...
            <div class="row">
                <div class="col s12">
                    ...
                    <div class="dismiss" style="padding: 15px 10px;">
                        <button type="submit" class="waves-effect">Ajouter</button>
                    </div>
                </div>
            </div>
